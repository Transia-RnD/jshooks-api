...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Remove import and export statements from a TypeScript file."
    )
    parser.add_argument(
        "input_file", type=str, help="Path to the input TypeScript file"
    )
    parser.add_argument(
        "output_file", type=str, nargs="?", help="Path to the output file (optional)"
    )
